...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--weights", type=str, default="yolov7_training.pt", help="initial weights path"
    )
    parser.add_argument(
        "--cfg",
        type=str,
        default="cfg/training/yolov7-custom.yaml",
        help="model.yaml path",
    )
    parser.add_argument(
        "--data", type=str, default="data/custom.yaml", help="data.yaml path"
    )
    parser.add_argument(
        "--hyp",
        type=str,
    ...
    parser.add_argument("--name", default="yolov7-custom", help="save to project/name")
    parser.add_argument(
        "--exist-ok",
        action="store_true",
